...
const info = [
    {
      image: freeFaces,
      title: 'Free Faces',
      description: 'Este sitio web es una colección seleccionada de tipos de letra que están disponibles bajo una variedad de licencias gratuitas para utilizar.',
